...
for(const label of ['学習目標ごとの残り学習量','残り学習量 約${estimate.days}日','現在の学習履歴','1日最大10課題'])if(!home.includes(label))fail(`Home missing: ${label}`)
...
console.log('PASS: A60/B70/C75 残り学習量・最大10課題/日・レスポンシブ表示')
