...
for(const token of ['completedCoreByTarget','markRequiredYearComplete','sourcePracticeProgress','requiredYearComplete(year,target)'])if(!route.includes(token))fail(`route completion guard missing: ${token}`)
