...
const home=read('src/pages/Home.tsx'),eta=read('src/targetEta.ts'),route=read('src/learningRoute.ts'),main=read('src/main.tsx'),paper=read('src/pages/PastPapers.tsx'),remediation=read('src/pages/Remediation.tsx'),css=read('src/homeRoute.css')
...
console.log('PASS: simple monotonic ETA is render-pure, locks at completion boundaries, and excludes optional old-year extras')
