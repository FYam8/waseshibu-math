...
if(migration.includes('CURRENT_DATA_VERSION=3')&&backup.includes('GUIDED_REVIEW_STORAGE_KEY')&&version.includes("APP_VERSION='0.13.2'")&&publicVersion.includes('"appVersion": "0.13.2"')&&publicVersion.includes('"dataVersion": 3'))ok('v0.13.2・data v3・既存学習データ保護');else fail('版・データ形式整合')
