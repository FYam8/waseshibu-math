...
const checks=[
 ...
 ['selective old-year note',home.includes('2019〜2021年度の別枠演習はエクストラです')],
 ['2019 UI label',fs.readFileSync('src/pages/Years.tsx','utf8').includes('構成が異なる年度')],
 ['reinforcement purpose',reinforce.includes('年度の固定類題')],
 ['score validity type',types.includes("scoreValidity?: 'first-look' | 'reference'")],
 ['score validity save',past.includes("scoreValidity:!prior&&firstLookEligible&&!hasRelatedStudyExposure(year)?'first-look':'reference'")],
