...
2026-09-01の設計変更により、現在の正本は次です。

- 必須年度: 2022, 2023, 2024, 2025, 2026
- 学習順: 2024診断 → 2023改善確認① → 2022改善確認② → 2025実戦確認 → 2026最終確認
- 各年度は年度通しだけで終わらず、未解決元問題と弱点補強まで完了して次へ進む
- 2019〜2021は追加補強・任意演習
- 2022/2023は旧年度補強プールから除外し、必須年度通しとして扱う
- 後の年度を先に開いても、手前の必須年度を飛ばさない
- ETAは2022〜2026の5年度を必須学習量に含める

以下のv0.17.8記述は当時の監査履歴として残しますが、年度ロールについては上記が優先です。
