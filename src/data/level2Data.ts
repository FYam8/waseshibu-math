...
const explanationOverrides:Record<string,string>={
  ...
  'L2-2026-Q5-3':'前問よりAC=12、AD=3、DC=9、BC=12。AB=BDなので点Bは線分ADの垂直二等分線上にある。ADの中点をMとするとAM=DM=3/2、BM⊥AD。A,D,Cは一直線なのでBM⊥ACでもあり、CM=CD+DM=9+3/2=21/2。直角三角形BCMよりBM²=BC²−CM²=12²−(21/2)²=135/4。直角三角形ABMよりAB²=AM²+BM²=(3/2)²+135/4=36。よってAB=BD=6。次にD,A,Cは一直線、B,D,Fは一直線、AB∥CFなので△DAB∽△DCF。したがってAD:DC=AB:CF=3:9。3:9=6:CFよりCF=18。'
}
