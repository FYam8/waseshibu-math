...
export const WASESHIBU_APP_PROFILE = {
  ...
  targets: [
    { id: '60', label: '60点', rank: 1, scoreThreshold: 60, legacyValue: 60 },
    { id: '70', label: '70点', rank: 2, scoreThreshold: 70, legacyValue: 70 },
    { id: '75', label: '75点', rank: 3, scoreThreshold: 75, legacyValue: 75 }
  ],
  learningPhases: [
    { step: 1, title: '2024年度で診断', year: 2024, examIds: ['waseshibu-2024'], role: 'diagnostic' },
    { step: 2, title: '2024年度の弱点を修正・補強', year: 2024, examIds: ['waseshibu-2024'], role: 'remediation' },
    { step: 3, title: '2023年度で改善確認①', year: 2023, examIds: ['waseshibu-2023'], role: 'checkpoint' },
    { step: 4, title: '2022年度で改善確認②', year: 2022, examIds: ['waseshibu-2022'], role: 'checkpoint' },
    { step: 5, title: '2025年度で実戦確認', year: 2025, examIds: ['waseshibu-2025'], role: 'practice' },
    { step: 6, title: '2026年度で最終確認', year: 2026, examIds: ['waseshibu-2026'], role: 'final' }
  ],
  runtime: {
