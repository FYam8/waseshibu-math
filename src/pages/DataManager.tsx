...
export default function DataManager(){
  ...
  return <>
    <div className="page-head"><div><span className="eyebrow">LOCAL DATA</span><h1>データ管理</h1><p className="muted">学習データはまずこの端末に保存されます。Cloud同期が有効な環境では、学習件数・最終学習時刻・年度進捗・過去問得点などの進捗要約を自動バックアップします。入力した答案や問題本文はCloudへ送りません。</p></div></div>
