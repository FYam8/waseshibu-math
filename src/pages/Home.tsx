...
import { strategyForStoredExam, targetProfile } from '../targetStrategy'
...
export default function Home(){
  ...
  const targetStrategy=latest?strategyForStoredExam(prefs.target,latest,loadAttempts()):null
